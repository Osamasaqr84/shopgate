...
import com.codesroots.osamaomar.shopgate.entities.ForgetPasswordResponse;
...
public class RegisterViewModel extends ViewModel {
    ...
    public MutableLiveData<ForgetPasswordResponse> forgetResponseMutableLiveData = new MutableLiveData<>();
   ...
   public void userLogin(User user)
    ...
    public boolean isMail(String mail)
    {
     ...
     public void forgetPassword(String mail) {
        mCompositeDisposable.add(
                serverGateway.forgetPassword(mail)
                        .subscribeOn(Schedulers.io())
                        .observeOn(AndroidSchedulers.mainThread())
                        .subscribe(this::postDataResponseForForget,
                                this::postError));
    }


    private void postDataResponseForForget(ForgetPasswordResponse response) {
        forgetResponseMutableLiveData.postValue(response);
    }
