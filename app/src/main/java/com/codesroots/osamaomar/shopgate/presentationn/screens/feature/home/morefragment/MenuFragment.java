...
import com.codesroots.osamaomar.shopgate.BuildConfig;
...
public class MenuFragment extends Fragment {
    ...
    private TextView currency, lang, login, logout, contact, about, terms, chat,change_country,share_app;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        if (ResourceUtil.getCurrentLanguage(getActivity()).matches("en")) {
            ...
            change_country.setCompoundDrawablesWithIntrinsicBounds(0, 0, R.drawable.ic_next, 0);
            share_app.setCompoundDrawablesWithIntrinsicBounds(0, 0, R.drawable.ic_next, 0);
        }
        if (PreferenceHelper.getUserId() > 0)
        ...
        share_app.setOnClickListener(v -> {
            ...
            sendIntent.putExtra(Intent.EXTRA_TEXT,
                    "Hey check out my app at: https://play.google.com/store/apps/details?id=com.codesroots.hossam.shopgate&hl=en=");
    ...
    private void showDialog(List<Currency.DataBean> dataBeanList) {
        ...
        builderSingle.setTitle(getText(R.string.select_one));
        ...
        builderSingle.setAdapter(arrayAdapter, (dialog, which) -> {
            ...
            builderInner.setTitle(getText(R.string.your_selected));
